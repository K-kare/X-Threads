...
from .form  import MeepForm, SignUpForm, ProfilePicForm
...
def login_user(request):
    if request.method == "POST":
         ...
         if user is not None:
              ...
              messages.success(request, ("There was an error logging you in Please try again later."))
...
def delete_meep(request, pk):
     if request.user.is_authenticated:
          ...
          if request.user.username == meep.user.username:
               meep.delete()
               messages.success(request, ("Yep! The Meep has been Deleted!!"))
               return redirect(request.META.get("HTTP_REFERER"))
          else:
